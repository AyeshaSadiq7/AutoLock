...
import top.anonymous.ast.CombineLockVisitor;
import top.anonymous.ast.CompilationUnitASTRequestor;
import top.anonymous.entity.LockStatementInfo;
...
public class ASTUtil {
    ...
    public static CompilationUnit getCompilationUnit(File file, ASTParser tParser){
        ...
        ASTParser parser;
        if(tParser == null){
            parser = ASTParser.newParser(top.anonymous.env.Env.JAVA_VERSION);
