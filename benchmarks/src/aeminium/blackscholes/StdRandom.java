...
public final class StdRandom {
	...
	@Perm(requires = "share(seed) * unique(random) in alive", ensures = "share(seed) * unique(random) in alive")
	...
	@Perm(requires = "pure(seed) in alive", ensures = "pure(seed) in alive")
	...
	@Perm(requires = "pure(random) in alive", ensures = "pure(random) in alive")
	...
	@Perm(requires = "pure(random) in alive", ensures = "pure(random) in alive")
	public static int uniformO2(int N) {
		try {
			random_seedLock.readLock().lock();
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static int uniformO3(int a, int b) {
		try {
			random_seedLock.readLock().lock();
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static boolean bernoulliO1(double p) {
		try {
			random_seedLock.readLock().lock();
			return uniformO1() < p;
		} finally {
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static boolean bernoulliO2() {
		return bernoulliO1(0.5);
	}
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static double gaussianO1() {
		double r, x, y;
		do {
			x = uniform(-1.0, 1.0);
			y = uniform(-1.0, 1.0);
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static double gaussianO2(double mean, double stddev) {
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static void shuffleO1(Object[] a) {
		int N = a.length;
		for (int i = 0; i < N; i++) {
			random_seedLock.readLock().lock();
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static void shuffleO2(double[] a) {
		int N = a.length;
		for (int i = 0; i < N; i++) {
			random_seedLock.readLock().lock();
			int r = i + uniformO2(N - i);
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static void shuffleO3(int[] a) {
		int N = a.length;
		for (int i = 0; i < N; i++) {
			random_seedLock.readLock().lock();
			int r = i + uniformO2(N - i);
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static void shuffleO4(Object[] a, int lo, int hi) {
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static void shuffleO5(double[] a, int lo, int hi) {
		if (lo < 0 || lo > hi || hi >= a.length)
			throw new RuntimeException("Illegal subarray range");
		for (int i = lo; i <= hi; i++) {
			random_seedLock.readLock().lock();
	...
	@Perm(requires = "no permission in alive", ensures = "no permission in alive")
	public static void shuffleO6(int[] a, int lo, int hi) {
		if (lo < 0 || lo > hi || hi >= a.length)
			throw new RuntimeException("Illegal subarray range");
		for (int i = lo; i <= hi; i++) {
			random_seedLock.readLock().lock();
