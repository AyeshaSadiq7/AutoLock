...
public class Complex {
	...
	public double re;
	public double im;
	@Perm(requires = "unique(re) * unique(im) in alive", ensures = "unique(re) * unique(im) in alive")
	...
	@Perm(requires = "immutable(re) * immutable(im) in alive", ensures = "immutable(re) * immutable(im) in alive")
