...
public class Vec implements java.io.Serializable {
	...
	public double y;
	public double z;
	@Perm(requires = "unique(x) * unique(y) * unique(z) in alive", ensures = "unique(x) * unique(y) * unique(z) in alive")
	...
	@Perm(requires = "share(x) * share(y) * share(z) in alive", ensures = "share(x) * share(y) * share(z) in alive")
	...
	@Perm(requires = "pure(x) * pure(y) * pure(z) in alive", ensures = "pure(x) * pure(y) * pure(z) in alive")
	...
	@Perm(requires = "pure(y) * pure(z) * pure(x) in alive", ensures = "pure(y) * pure(z) * pure(x) in alive")
