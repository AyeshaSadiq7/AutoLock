...
class particle {
	...
	@Perm(requires = "unique(xcoord) * unique(ycoord) * unique(zcoord) * unique(xvelocity) * unique(yvelocity) * unique(zvelocity) * unique(xforce) * unique(yforce) * unique(zforce) in alive", ensures = "unique(xcoord) * unique(ycoord) * unique(zcoord) * unique(xvelocity) * unique(yvelocity) * unique(zvelocity) * unique(xforce) * unique(yforce) * unique(zforce) in alive")
	public particle(double xco, double yco, double zco, double xvel, double yvel, double zvel, double xfor, double yfor,
			double zfor) {
		count_epot_interactions_one_vir_xcoord_xforce_xvelocity_ycoord_yforce_yvelocity_zcoord_zforce_zvelocityLock
				.writeLock().lock();
		this.xcoord = xco;
		this.ycoord = yco;
		this.zcoord = zco;
	...
	@Perm(requires = "full(xcoord) * share(xvelocity) * share(xforce) * full(ycoord) * share(yvelocity) * share(yforce) * full(zcoord) * share(zvelocity) * share(zforce) in alive", ensures = "full(xcoord) * share(xvelocity) * share(xforce) * full(ycoord) * share(yvelocity) * share(yforce) * full(zcoord) * share(zvelocity) * share(zforce) in alive")
	...
	@Perm(requires = "pure(xcoord) * pure(ycoord) * pure(zcoord) * pure(one) * share(epot) * share(vir) * share(xforce) * share(yforce) * share(zforce) * unique(interactions) in alive", ensures = "pure(xcoord) * pure(ycoord) * pure(zcoord) * pure(one) * share(epot) * share(vir) * share(xforce) * share(yforce) * share(zforce) * unique(interactions) in alive")
	...
	@Perm(requires = "share(xforce) * share(yforce) * share(zforce) * share(xvelocity) * share(yvelocity) * share(zvelocity) in alive", ensures = "share(xforce) * share(yforce) * share(zforce) * share(xvelocity) * share(yvelocity) * share(zvelocity) in alive")
	...
	@Perm(requires = "pure(xvelocity) * pure(yvelocity) * pure(zvelocity) * share(count) in alive", ensures = "pure(xvelocity) * pure(yvelocity) * pure(zvelocity) * share(count) in alive")
	...
	@Perm(requires = "share(xvelocity) * share(yvelocity) * share(zvelocity) in alive", ensures = "share(xvelocity) * share(yvelocity) * share(zvelocity) in alive")
...
class random {
	...
	public int iseed;
	public double v1, v2;
	@Perm(requires = "none(iseed) * none(v1) * none(v2) * unique(iseed) * unique(v1) * unique(v2) in alive", ensures = "none(iseed) * none(v1) * none(v2) * unique(iseed) * unique(v1) * unique(v2) in alive")
	...
	@Perm(requires = "share(iseed) in alive", ensures = "share(iseed) in alive")
	...
	@Perm(requires = "full(v1) * full(v2) in alive", ensures = "full(v1) * full(v2) in alive")
	public double seed() {
		double s, u1, u2, r;
		do {
			iseed_v1_v2Lock.writeLock().lock();
