...
public class JGFMonteCarloBench extends CallAppDemo implements JGFSection3 {
	...
	@Perm(requires = "pure(JGFavgExpectedReturnRateMC) * pure(size) in alive", ensures = "pure(JGFavgExpectedReturnRateMC) * pure(size) in alive")
	...
	@Perm(requires = "unique(datasizes) in alive", ensures = "unique(datasizes) in alive")
