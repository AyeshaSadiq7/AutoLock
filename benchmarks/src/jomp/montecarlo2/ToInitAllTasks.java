...
public class ToInitAllTasks implements java.io.Serializable {
	...
	@Perm(requires = "unique(header) * unique(name) * unique(startDate) * unique(endDate) * unique(dTime) * unique(returnDefinition) * unique(expectedReturnRate) * unique(volatility) * unique(nTimeSteps) * unique(pathStartValue) in alive", ensures = "unique(header) * unique(name) * unique(startDate) * unique(endDate) * unique(dTime) * unique(returnDefinition) * unique(expectedReturnRate) * unique(volatility) * unique(nTimeSteps) * unique(pathStartValue) in alive")
	public ToInitAllTasks(String header, String name, int startDate, int endDate, double dTime, int returnDefinition,
			double expectedReturnRate, double volatility, double pathStartValue) {
		dTime_endDate_expectedReturnRate_header_nTimeSteps_name_pathStartValue_returnDefinition_startDate_volatilityLock
				.writeLock().lock();
		this.header = header;
		this.name = name;
	...
	@Perm(requires = "none(pathStartValue) * unique(name) * unique(startDate) * unique(endDate) * unique(dTime) * unique(returnDefinition) * unique(expectedReturnRate) * unique(volatility) * unique(nTimeSteps) * unique(pathStartValue) * none(name) * none(startDate) * none(endDate) * none(dTime) in alive", ensures = "none(pathStartValue) * unique(name) * unique(startDate) * unique(endDate) * unique(dTime) * unique(returnDefinition) * unique(expectedReturnRate) * unique(volatility) * unique(nTimeSteps) * unique(pathStartValue) * none(name) * none(startDate) * none(endDate) * none(dTime) in alive")
	...
	@Perm(requires = "pure(startDate) in alive", ensures = "pure(startDate) in alive")
	...
	@Perm(requires = "full(startDate) in alive", ensures = "full(startDate) in alive")
	...
	@Perm(requires = "pure(endDate) in alive", ensures = "pure(endDate) in alive")
	...
	@Perm(requires = "full(endDate) in alive", ensures = "full(endDate) in alive")
	...
	@Perm(requires = "pure(dTime) in alive", ensures = "pure(dTime) in alive")
	...
	@Perm(requires = "full(dTime) in alive", ensures = "full(dTime) in alive")
	...
	@Perm(requires = "full(nTimeSteps) in alive", ensures = "full(nTimeSteps) in alive")
	...
	@Perm(requires = "full(pathStartValue) in alive", ensures = "full(pathStartValue) in alive")
