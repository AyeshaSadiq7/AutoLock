...
public class AppDemo extends Universal {
	...
	@Perm(requires = "unique(dataDirname) * unique(dataFilename) * unique(nTimeStepsMC) * unique(nRunsMC) * unique(initialised) * none(prompt) * none(DEBUG) * unique(prompt) * unique(DEBUG) in alive", ensures = "unique(dataDirname) * unique(dataFilename) * unique(nTimeStepsMC) * unique(nRunsMC) * unique(initialised) * none(prompt) * none(DEBUG) * unique(prompt) * unique(DEBUG) in alive")
	...
	RatePath rateP = null;
	@Perm(requires = "pure(dataDirname) * pure(dataFilename) * unique(initAllTasks) * pure(nTimeStepsMC) * immutable(pathStartValue) * pure(nRunsMC) in alive", ensures = "pure(dataDirname) * pure(dataFilename) * unique(initAllTasks) * pure(nTimeStepsMC) * immutable(pathStartValue) * pure(nRunsMC) in alive")
	...
	@Perm(requires = "unique(results) * pure(nRunsMC) * pure(initAllTasks) * share(tasks) in alive", ensures = "unique(results) * pure(nRunsMC) * pure(initAllTasks) * share(tasks) in alive")
	...
	@Perm(requires = "unique(tasks) in alive", ensures = "unique(tasks) in alive")
	...
	@Perm(requires = "pure(nRunsMC) * share(results) * full(JGFavgExpectedReturnRateMC) in alive", ensures = "pure(nRunsMC) * share(results) * full(JGFavgExpectedReturnRateMC) in alive")
	...
	@Perm(requires = "pure(dataDirname) in alive", ensures = "pure(dataDirname) in alive")
	...
	@Perm(requires = "full(dataDirname) in alive", ensures = "full(dataDirname) in alive")
	...
	@Perm(requires = "pure(dataFilename) in alive", ensures = "pure(dataFilename) in alive")
	...
	@Perm(requires = "full(dataFilename) in alive", ensures = "full(dataFilename) in alive")
	...
	@Perm(requires = "pure(nTimeStepsMC) in alive", ensures = "pure(nTimeStepsMC) in alive")
	...
	@Perm(requires = "full(nTimeStepsMC) in alive", ensures = "full(nTimeStepsMC) in alive")
	...
	@Perm(requires = "pure(nRunsMC) in alive", ensures = "pure(nRunsMC) in alive")
	...
	@Perm(requires = "full(nRunsMC) in alive", ensures = "full(nRunsMC) in alive")
	...
	@Perm(requires = "pure(tasks) in alive", ensures = "pure(tasks) in alive")
	...
	@Perm(requires = "share(tasks) in alive", ensures = "share(tasks) in alive")
	...
	@Perm(requires = "pure(results) in alive", ensures = "pure(results) in alive")
	...
	@Perm(requires = "share(results) in alive", ensures = "share(results) in alive")
